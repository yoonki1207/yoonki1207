...
## [교육] 강남대학교-벤처스타트업아카데미 [2024.03 ~ 2025.02]

- 벤처스타트업 주관 웹 개발자 양성 프로그램
    - SpringBoot, Flask 프레임워크 교육 이수
...
- [중소벤처기업부] 2024 벤처스타트업 아카데미 해커톤 | 장려상
- [강남대학교] 2024 학술세미나 팀-라디 | 최우수상
- [강남대학교] 2019 학술세미나 팀-자율주행 | 장려상

---

# 자격증

- 삼성 SW 역량테스트 B형 (삼성 / 2025.02)
- SQLD (한국데이터산업진흥원 / 2025.06.27)
...
<img width="1511" height="636" alt="Screenshot 2026-09-18 at 12 56 30 AM" src="https://github.com/user-attachments/assets/eec2bb5b-575b-4203-a072-ccbf65b7f18c" />

<aside>

**기간/인원**: 2026.06.19 - 2026.07.25 · 5주 · 5명

**역할**: 팀장(일정 관리, 발표·데모 준비), RBAC 및 RAG 권한 경계 일부 설계·구현

**스킬**: Python3.11, FastAPI, PostgreSQL, NextJS, Docker compose, AWS

**GitHub**: https://github.com/yoonki1207/nodease

**발표 영상**: https://www.youtube.com/watch?v=HAmCgrVxbWM
...
<img width="1456" height="903" alt="Screenshot 2026-09-18 at 12 57 35 AM" src="https://github.com/user-attachments/assets/236c9efb-8d86-4482-9616-8d12241d8ad1" />

<aside>

**기간**: 2026.04.24 - 2026.05.21 · 4주

**역할**: 우선순위 선점 스케줄링, Semaphore·Condition Variable 우선순위 처리

**기술**: C

**GitHub**: https://github.com/Jungle-12-303/week09-team-05-pintos-threads
...
<img width="647" height="386" alt="Screenshot 2026-09-18 at 1 25 38 AM" src="https://github.com/user-attachments/assets/2ea32c38-868d-41b3-b327-f6379375c926" />


<aside>

**기간/인원**: 2023.07.01 - 2024.02.20 · 7개월 · 6명

**역할**: 백엔드 — 번개 모임 API, 실시간 채팅

**기술**: Java 17, Spring Boot 3.1, STOMP/WebSocket, MongoDB

**GitHub**: https://github.com/AUNAE-WEB-Dev
...
“우리 학교뿐 아니라 주변 환경에 도움이 되는 비즈니스 서비스를 만드시오”라는 주제에서 학생 간 심부름 요청과 수행을 연결해 주는 중개 서비스를 개발했습니다.

<img width="633" height="543" alt="Screenshot 2026-09-20 at 12 04 31 AM" src="https://github.com/user-attachments/assets/61bc538d-1f81-4179-8d7f-9251013d0e16" />

<aside>

**기간/인원**: 2024.08.19 - 2024.08.20 · 1박 2일 · 4명

**역할**: 백엔드 — 로그인·회원가입, 정산, 심부름 요청·수행

**기술**: Flutter, Dart, Python, FastAPI

**GitHub**: https://github.com/SURFERTON/backend
